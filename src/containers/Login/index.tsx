        ...
        try {
            if (this.props.valid) {
                ...
                if (responseLogin.type === actionTypes.LOGIN_SUCCESS) {
                    const responseRefreshToken = await this.props.actions.newRefreshToken(
                        user,
                    );
                    await Keychain.setGenericPassword(
                        REFRESH_TOKEN,
                        responseRefreshToken.success.refreshToken,
                    );
...
function mapStateToProps(state: { loginReducer: any; }) {
